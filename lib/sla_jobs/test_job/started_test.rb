module TestJob
  ...
  class StartedTest
    ...
    EVENT_TYPE_NOT_ONCE = 'STARTED_TEST_NOT_ONCE'.freeze
    ...
    def start
      ...
      @live_schedules.each do |live_schedule|
        ...
        if execution.nil? && notification_log.nil?
      ...
      @execution_log.each do |execution|
        ...
        # Taking only executions with live schedule
        ...
        if schedule.settings_server.server_type == 'cloudconnect'
          ...
          elsif running_execution.nil? && running_late_for >= 60
