...
Devise.setup do |config|
  ...
  # config.pepper = "d9ebb69e8467fda1fb7d1d4e67caeba0d583f435b09b684430a0f3e96bb1ff9826e58bf32966c68ff7e775dbf4995e9f633787d77f87e758a249d0d137efed19"
  ...
  secret_key = (secret_key_path.exist? and secret_key_path.read.chomp) or (
    ...
    SecureRandom.hex(128).tap do |token|
      secret_key_path.open('w') { |io| io.write token }
    end
  )
