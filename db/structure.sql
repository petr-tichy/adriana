...
--
-- Name: loadHistoryInitial_vojta(); Type: FUNCTION; Schema: log2; Owner: -
--

CREATE FUNCTION "loadHistoryInitial_vojta"() RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    myRecords RECORD;
BEGIN
    -- CUSTOMER HISTORY
    FOR myRecords IN SELECT id, name, email, contact_person FROM log2.customer LOOP
        -- jmeno
        INSERT INTO log2.customer_history (customer_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.name, null, null, 'name');
        -- email
        INSERT INTO log2.customer_history (customer_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.email, null, null, 'email');
        -- contact_person
        INSERT INTO log2.customer_history (customer_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.contact_person, null, null, 'contact_person');
     
    END LOOP;

    -- CONTRACT HISTORY
    FOR myRecords IN SELECT id, name, is_deleted, customer_id, sla_enabled, sla_type, sla_value, sla_percentage, monitoring_enabled, monitoring_emails, monitoring_treshhold, salesforce_id, contract_type  FROM log2.contract LOOP
        -- jmeno
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.name, null, null, 'name');
        -- is_deleted
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.is_deleted, null, null, 'is_deleted');
        -- customer_id
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.customer_id, null, null, 'customer_id');
        -- sla_enabled
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.sla_enabled, null, null, 'sla_enabled');
        -- sla_type
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.sla_type, null, null, 'sla_type');
       -- sla_value
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.sla_value, null, null, 'sla_value');
        -- sla_percentage
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.sla_percentage, null, null, 'sla_percentage');
        -- monitoring_enabled
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.monitoring_enabled, null, null, 'monitoring_enabled');
        -- monitoring_emails
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.monitoring_emails, null, null, 'monitoring_emails');
        -- monitoring_treshhold
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.monitoring_treshhold, null, null, 'monitoring_treshhold');
        
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.salesforce_id, null, null, 'salesforce_id');
        
        INSERT INTO log2.contract_history (contract_id, value, valid_from, valid_to, key)
        VALUES (myRecords.id, myRecords.contract_type, null, null, 'contract_type');
    END LOOP;

     -- PROJECT HISTORY
    FOR myRecords IN SELECT project_pid, contract_id  FROM log2.project LOOP
        -- jmeno
        INSERT INTO log2.project_history (project_pid, value, valid_from, valid_to, key)
        VALUES (myRecords.project_pid, myRecords.contract_id, null, null, 'contract_id');
...
--
-- Name: pg_schema_size_filter(text, text); Type: FUNCTION; Schema: log2; Owner: -
--

CREATE FUNCTION pg_schema_size_filter(text, text) RETURNS bigint
    LANGUAGE sql
    AS $_$
...
--
-- Name: test(character varying); Type: FUNCTION; Schema: log2; Owner: -
--

CREATE FUNCTION test(pid character varying) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE 
	rowcount INTEGER;
...
BEGIN
	...
	RAISE WARNING 'Calling cs_create_job(%)', 1;		
	RETURN 1;	
...
--
-- Name: etl_attask_project; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE etl_attask_project (
    actualbenefit numeric(12,2),
    actualcompletiondate character varying(255),
    actualcost numeric(12,2),
    actualdurationminutes integer,
    actualexpensecost numeric(12,2),
    actuallaborcost numeric(12,2),
    actualrevenue numeric(12,2),
    actualriskcost numeric(12,2),
    actualstartdate character varying(255),
    actualvalue numeric(12,2),
    actualworkrequired integer,
    alignment character varying(255),
    alignmentscorecardid character varying(255),
    allapprovedhours numeric(12,2),
    allunapprovedhours character varying(255),
    approvalprocessid character varying(255),
    audittypes character varying(255),
    autobaselinerecuron integer,
    autobaselinerecurrencetype character varying(255),
    bccompletionstate character varying(255),
    billedrevenue numeric(12,2),
    budget numeric(12,2),
    budgetedcompletiondate character varying(255),
    budgetedcost numeric(12,2),
    budgetedhours numeric(12,2),
    budgetedlaborcost numeric(12,2),
    budgetedstartdate character varying(255),
    budgetstatus integer,
    categoryid character varying(255),
    companyid character varying(255),
    completiontype character varying(255),
    condition character varying(255),
    conditiontype character varying(255),
    cpi numeric(12,2),
    csi numeric(12,2),
    currentapprovalstepid character varying(255),
    customerid character varying(255),
    de_account_owner character varying(255),
    de_action_plan character varying(255),
    de_approved_hours character varying(255),
    de_archiver character varying(255),
    de_automatic_validation character varying(255),
    de_average_duration character varying(255),
    de_basecamp character varying(255),
    de_billing_type character varying(255),
    de_budget_hours character varying(255),
    de_condition_indicator character varying(255),
    de_confluence character varying(255),
    de_connectors character varying(255),
    de_cron character varying(255),
    de_customer_contact_email character varying(255),
    de_customer_contact_name character varying(255),
    de_customer_name character varying(255),
    de_design_review character varying(255),
    de_design_review_link character varying(255),
    de_directory_name character varying(255),
    de_expiration_period character varying(255),
    de_external_org_dependencies character varying(255),
    de_file_ex_check character varying(255),
    de_hours_per_period character varying(255),
    de_implementation_documentation character varying(255),
    de_info_sfdc character varying(255),
    de_infrastructure character varying(255),
    de_investment_hours character varying(255),
    de_investment_reason character varying(255),
    de_legacy character varying(255),
    de_legacy_budget_hours numeric(12,2),
    de_legacy_id character varying(255),
    de_mrr character varying(255),
    de_needs_review character varying(255),
    de_note character varying(255),
    de_numeric_of_periods character varying(255),
    de_operational_status character varying(255),
    de_practice_group character varying(255),
    de_product_id character varying(255),
    de_product_name character varying(255),
    de_project_pid character varying(255),
    de_project_type character varying(255),
    de_project_without_go_live character varying(255),
    de_restart character varying(255),
    de_rollout character varying(255),
    de_rollout_review_link character varying(255),
    de_running_on character varying(255),
    de_salesforce_id character varying(255),
    de_salesforce_name character varying(255),
    de_salesforce_type character varying(255),
    de_service_type character varying(255),
    de_sf_downloader_version character varying(255),
    de_share_in_weekly_status_update character varying(255),
    de_sla_enabled character varying(255),
    de_sla_type character varying(255),
    de_sla_value character varying(255),
    de_solution_architect character varying(255),
    de_solution_engineer character varying(255),
    de_status_update_overview character varying(255),
    de_su character varying(255),
    de_tech_user character varying(255),
    de_technical_overview character varying(255),
    de_tier character varying(255),
    de_time_zone character varying(255),
    de_token character varying(255),
    de_total_service_hours character varying(255),
    de_uses_es character varying(255),
    de_uses_ftp character varying(255),
    de_working_hours character varying(255),
    deliverablescorecardid character varying(255),
    deliverablesuccessscore character varying(255),
    deliverablesuccessscoreratio character varying(255),
    description character varying(255),
    displayorder character varying(255),
    durationminutes character varying(255),
    eac character varying(255),
    enableautobaselines character varying(255),
    enteredbyid character varying(255),
    entrydate character varying(255),
    estcompletiondate character varying(255),
    eststartdate character varying(255),
    extrefid character varying(255),
    filterhourtypes character varying(255),
    financelastupdatedate character varying(255),
    fixedcost character varying(255),
    fixedenddate character varying(255),
    fixedrevenue character varying(255),
    fixedstartdate character varying(255),
    groupid character varying(255),
    hasbudgetconflict character varying(255),
    hascalcerror character varying(255),
    hascompletionconstraint character varying(255),
    hasdocuments character varying(255),
    hasexpenses character varying(255),
    hasmessages character varying(255),
    hasnotes character varying(255),
    hasrateoverride character varying(255),
    hasresolvables character varying(255),
    hasstartconstraint character varying(255),
    hastimednotifications character varying(255),
    id character varying(255),
    lastcalcdate character varying(255),
    lastconditionnoteid character varying(255),
    lastnoteid character varying(255),
    lastupdatedate character varying(255),
    lastupdatedbyid character varying(255),
    levelingmode character varying(255),
    milestonepathid character varying(255),
    name character varying(255),
    nextautobaselinedate character varying(255),
    numericopenoptasks character varying(255),
    olv character varying(255),
    optimizationscore character varying(255),
    ownerid character varying(255),
    ownerprivileges character varying(255),
    percentcomplete character varying(255),
    performanceindexmethod character varying(255),
    personal character varying(255),
    plannedbenefit character varying(255),
    plannedcompletiondate character varying(255),
    plannedcost character varying(255),
    plannedexpensecost character varying(255),
    plannedlaborcost character varying(255),
    plannedrevenue numeric(12,2),
    plannedriskcost character varying(255),
    plannedstartdate character varying(255),
    plannedvalue character varying(255),
    popaccountid character varying(255),
    portfolioid character varying(255),
    portfoliopriority character varying(255),
    previousstatus character varying(255),
    priority character varying(255),
    programid character varying(255),
    progressstatus character varying(255),
    projectedcompletiondate character varying(255),
    projectedstartdate character varying(255),
    queuedefid character varying(255),
    referencenumeric character varying(255),
    rejectionissueid character varying(255),
    remainingcost character varying(255),
    remainingrevenue character varying(255),
    remainingriskcost character varying(255),
    resourcepoolid character varying(255),
    risk character varying(255),
    riskperformanceindex character varying(255),
    roi character varying(255),
    scheduleid character varying(255),
    schedulemode character varying(255),
    selectedonportfoliooptimizer character varying(255),
    spi character varying(255),
    sponsorid character varying(255),
    status character varying(255),
    statusupdate character varying(255),
    submittedbyid character varying(255),
    templateid character varying(255),
    totalhours character varying(255),
...
--
-- Name: project_history_old; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE project_history_old (
    id integer NOT NULL,
    project_pid text,
    old_value text,
    new_value text,
...
ALTER SEQUENCE project_history_id_seq OWNED BY project_history_old.id;


--
-- Name: project_history_new_id_seq; Type: SEQUENCE; Schema: log2; Owner: -
--

CREATE SEQUENCE project_history_new_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: project_history_new_id_seq; Type: SEQUENCE OWNED BY; Schema: log2; Owner: -
--

ALTER SEQUENCE project_history_new_id_seq OWNED BY project_history.id;
...
--
-- Name: schedule_history_old; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--
...
--
-- Name: schedule_history_old_id_seq; Type: SEQUENCE; Schema: log2; Owner: -
--

CREATE SEQUENCE schedule_history_old_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: schedule_history_old_id_seq; Type: SEQUENCE OWNED BY; Schema: log2; Owner: -
--

ALTER SEQUENCE schedule_history_old_id_seq OWNED BY schedule_history_old.id;
...
--
-- Name: src_file_attask_project; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE src_file_attask_project (
    actualbenefit numeric(12,2),
    actualcompletiondate character varying(255),
    actualcost numeric(12,2),
    actualdurationminutes integer,
    ...
    de_needs_review character varying(255),
    de_note character varying(255),
    de_number_of_periods character varying(255),
    de_operational_status character varying(255),
    de_practice_group character varying(255),
    de_product_id character varying(255),
    de_product_name character varying(255),
    ...
    name character varying(255),
    nextautobaselinedate character varying(255),
    numberopenoptasks character varying(255),
    olv character varying(255),
    optimizationscore character varying(255),
    ownerid character varying(255),
    ownerprivileges character varying(255),
...
--
-- Name: temp_contract_history; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE temp_contract_history (
...
--
-- Name: temp_contract_history_denorm; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE temp_contract_history_denorm (
    contract_id character varying(255),
    sla_enabled boolean,
    sla_type character varying(100),
    sla_value character varying(100),
    sla_percentage character varying(100),
    salesforce_id character varying(100),
...
--
-- Name: temp_project_history; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE temp_project_history (
    project_pid character varying(255),
    valid_from date,
    valid_to date,
    key character varying(100),
...
--
-- Name: temp_project_history_denorm; Type: TABLE; Schema: log2; Owner: -; Tablespace: 
--

CREATE TABLE temp_project_history_denorm (
    project_pid character varying(255),
    status character varying(100),
    sla_enabled boolean,
    sla_type character varying(100),
...
ALTER TABLE ONLY project_history ALTER COLUMN id SET DEFAULT nextval('project_history_new_id_seq'::regclass);
...
ALTER TABLE ONLY project_history_old ALTER COLUMN id SET DEFAULT nextval('project_history_id_seq'::regclass);
...
ALTER TABLE ONLY schedule_history_old ALTER COLUMN id SET DEFAULT nextval('schedule_history_old_id_seq'::regclass);
...
ALTER TABLE ONLY project_history_old
    ADD CONSTRAINT "IX_id" PRIMARY KEY (id);


--
-- Name: IX_id_new; Type: CONSTRAINT; Schema: log2; Owner: -; Tablespace: 
--

ALTER TABLE ONLY project_history
    ADD CONSTRAINT "IX_id_new" PRIMARY KEY (id);


--
-- Name: IX_schedule_history_id; Type: CONSTRAINT; Schema: log2; Owner: -; Tablespace: 
--

ALTER TABLE ONLY schedule_history_old
    ADD CONSTRAINT "IX_schedule_history_id" PRIMARY KEY (id);
...
--
-- Name: IX_project_pid_key_updated_at; Type: INDEX; Schema: log2; Owner: -; Tablespace: 
--

CREATE INDEX "IX_project_pid_key_updated_at" ON project_history_old USING btree (project_pid, key, updated_at);
...
--
-- Name: update_project_history; Type: TRIGGER; Schema: log2; Owner: -
--

CREATE TRIGGER update_project_history BEFORE INSERT ON project_history_old FOR EACH ROW EXECUTE PROCEDURE person_stamp();
