...
gem 'active_admin_role', '~> 0.2'
gem 'active_admin_theme', '~> 1.0'
gem 'activeadmin', '~> 1.4'
gem 'activeadmin-select2', git: 'https://github.com/NechiK/activeadmin-select2.git'
...
# These are for SLAWatcher related things
